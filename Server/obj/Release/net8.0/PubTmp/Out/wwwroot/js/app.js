...
class SwiperSlider {
    initSwiperSlider() {
        ...
        //Navigation Swiper
        if (document.querySelector("[data-swiper='navigation']")) {
            try {
        ...
        if (document.querySelectorAll("[data-swiper='dynamic']").length) {
            try {
        ...
        if (document.querySelectorAll("[data-swiper='fraction']")) {
            try {
                ...
                console.error('Error initializing the swiper:', error);
            }
        }

        // Pagination Custom Swiper
        if (document.querySelectorAll("[data-swiper='custom']")) {
            try {
        ...
        if (document.querySelectorAll("[data-swiper='progress']")) {
            try {
        ...
        // Scrollbar Swiper
        if (document.querySelectorAll("[data-swiper='scrollbar']")) {
            try {
        ...
        // Vertical Swiper
        if (document.querySelectorAll('[data-swiper="vertical"]')) {
            try {
        ...
        if (document.querySelectorAll("[data-swiper='mousewheel']")) {
            try {
                ...
                console.error('Error initializing the Swiper instance:', error);
            }
        }

        // Effect Fade Swiper
        if (document.querySelectorAll("[data-swiper='effect-fade']")) {
            try {
        ...
        if (document.querySelectorAll("[data-swiper='coverflow']")) {
            try {
        ...
        // Effect Flip Swiper
        if (document.querySelectorAll("[data-swiper='flip']")) {
            try {
        ...
        if (document.querySelectorAll("[data-swiper='creative']")) {
            try {
        ...
        // Responsive Swiper
        if (document.querySelectorAll("[data-swiper='responsive']")) {
            try {
...
window.sidenavMenuToggler = function () {
    new ThemeLayout().sidenavMenuToggler();
};

window.topbarMenuToggler = function () {
    new ThemeLayout().topbarMenuToggler();
};