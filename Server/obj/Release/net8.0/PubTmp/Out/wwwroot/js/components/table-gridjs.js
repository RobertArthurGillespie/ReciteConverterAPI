    ...
    GridjsTableInit() {
        ...
        if (document.getElementById("table-pagination")) {
            try {
                ...
                console.error('Error initializing the Grid table:', error);
            }
        }
        ...
        if (document.getElementById("table-search")) {
            try {
                ...
                console.error("Error initializing the data grid:", error);
            }
        }
        ...
        if (document.getElementById("table-loading-state")) {
            try {
                ...
                console.error('Error initializing the table grid:', error);
            }
        }
        ...
        if (document.getElementById("table-fixed-header")) {
            try {
                ...
                console.error('Error initializing the table with fixed header:', error);
            }
        }
