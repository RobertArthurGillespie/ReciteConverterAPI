...
window.loadSlider = function () {
    ...
    **********************/
    ...
    if (document.querySelectorAll('#rangeslider_basic')) {
        try {
            ...
            console.error('Error initializing the color scheme slider:', error);
        }
    }
    ...
    // vertical
    if (document.querySelectorAll('#rangeslider_vertical')) {
        try {
            ...
            console.error('Error initializing the vertical range slider:', error);
        }
    }
    ...
    **********************/
    ...
    if (document.querySelectorAll('#rangeslider_multielement')) {
        try {
            ...
            console.error('Error initializing the multi-element slider:', error);
        }
    }
    ...
    **********************/
    ...
    if (sliders) {
        try {
            ...
            console.error('Error initializing the sliders:', error);
        }
    }
    ...
    **********************/
    if (document.getElementById('nonlinear')) {
        try {
            ...
            console.error('Error initializing the nonlinear slider:', error);
        }
    }
    ...
    **********************/
    ...
    /*********************
        tooltip
    **********************/
    if (document.querySelectorAll('#slider-merging-tooltips')) {
        try {
            ...
            console.error('Error initializing the merging tooltip slider:', error);
        }
    }
    ...
    /*********************
        Soft limits
    **********************/
    if (document.getElementById('soft')) {
        try {
            ...
            console.error('Error initializing the soft slider:', error);
        }
    }
}